...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap-test-organization-jk/github-tests-go-gcphndwe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/github-tests-go-gcphndwe-gitops
...
export REKOR_HOST="https://rekor-server-trusted-artifact-signer.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com"
